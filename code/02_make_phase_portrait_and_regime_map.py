...
fig.tight_layout(); fig.savefig(FIG/"fig3_linear_response_functions.png",dpi=240); fig.savefig(FIG/"fig3_linear_response_functions.pdf"); plt.close(fig)
...
fig.tight_layout(); fig.savefig(FIG/"fig4_phase_portrait.png",dpi=240); fig.savefig(FIG/"fig4_phase_portrait.pdf"); plt.close(fig)
...
fig.tight_layout(); fig.savefig(FIG/"fig5_threshold_regime_map.png",dpi=240); fig.savefig(FIG/"fig5_threshold_regime_map.pdf"); plt.close(fig)
